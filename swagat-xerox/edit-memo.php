        ...
        <div class="editor-panel hide-on-print">
            <form id="memoForm" method="POST" action="api/save-memo.php">
                ...
                <div class="action-buttons sticky-bottom">
                    <button type="submit" class="btn btn-primary btn-lg w-100" id="saveBtn">Update Memo</button>
                    <button type="button" class="btn btn-secondary btn-lg w-100 mt-10" id="saveAndPrintBtn">Update & Print</button>
                </div>
            </form>
        </div>
